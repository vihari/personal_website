function fillCanvases(){
    var r1 = new renderContainer('clouds/band_cloud.pcd','canvas_bandCloud');
    var r2 = new renderContainer('clouds/registered_clouds.pcd','canvas_original');
    var r3 = new renderContainer('clouds/original_clouds.pcd','canvas_unregistered');
    var r4 = new renderContainer('clouds/registered_clouds.pcd','canvas_registered');
    r1.renderView();
    r2.renderView();
    r3.renderView();
    r4.renderView();
...
function renderContainer(pcd_file,canvas_name){
    ...
    var cam = new OrbitCam({closest:-100, farthest:100, distance: 100});
